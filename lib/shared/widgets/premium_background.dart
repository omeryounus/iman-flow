    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [ImanFlowTheme.bgTop, ImanFlowTheme.bgMid, ImanFlowTheme.bgBot],
        ),
      ),
      child: Stack(
        children: [
          Positioned(
            top: -120,
            left: -120,
            child: _Glow(color: ImanFlowTheme.gold.withOpacity(.18), size: 360),
          ),
          Positioned(
            bottom: -180,
            right: -160,
            child: _Glow(color: ImanFlowTheme.emeraldGlow.withOpacity(.10), size: 420),
          ),
          Positioned.fill(
...
class _ParticlesPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final gold = Paint()..color = ImanFlowTheme.gold.withOpacity(.20);
